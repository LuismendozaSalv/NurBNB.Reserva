...
{
    public class ReservaPropiedadFactory : IReservaPropiedadFactory
    {
        ...
        {
            return new ReservaPropiedad(fechaEntrada, fechaSalida, estado, tipoPago, montoTotal, propiedadId, guestId);
        }
    }
}
